...
// const InvoiceViewer = ({ invoiceNum, createdFor, toggleInvoiceEditor }) => {
//     const { id } = useParams()
...
//     const user = localStorage.getItem('user')
//     let { allStockOutData = [] } = useSelector((stat) => stat.stockOutList)
//     const { hospitalsData = [] } = useSelector((stat) => stat.hospitalList)

//     const dispatch = useDispatch()

//     useEffect(() => {
//         dispatch(allStockOutDatas(invoiceNum))
//         dispatch(getHospitalsData(createdFor))
//     }, [])

//     // if (allStockOutData.length != 0) {
//     //     useEffect(() => {
//     //         dispatch(getHospitalsData(allStockOutData[0].createdFor))
//     //     }, [dispatch])
//     // }

//     console.log('stockdata data', allStockOutData)
//     console.log('hospital Data', hospitalsData)

//     // var hospital = hospitalsData[0]
...
//                         <StyledH5 sx={{ mb: 1 }}>Order Info</StyledH5>
//                         <Paragraph sx={{ mb: 2 }}>Order Number</Paragraph>
//                         <Paragraph># {allStockOutData.invoiceNum}</Paragraph>
//                     </div>
//                     <TextBox>
//                         <StyledH5 sx={{ mb: 1 }}>
//                             <strong>Order status: </strong>
//                             <span>
//                                 {allStockOutData.status == true
//                                     ? 'Delivered'
//                                     : 'Pending'}
//                             </span>
//                         </StyledH5>
...
//                             <strong>Order date: </strong>
//                             <span>
//                                 {moment(allStockOutData.updatedAt).format(
//                                     'MMM Do, YYYY'
//                                 )}
//                             </span>
//                         </StyledH5>
...
//                     <div>
//                         <StyledH5 sx={{ mb: 1 }}>Bill From</StyledH5>
//                         <Paragraph sx={{ mb: 2 }}>{user.name}</Paragraph>
//                         <Paragraph sx={{ whiteSpace: 'pre' }}>
