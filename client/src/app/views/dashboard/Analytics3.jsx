...
import { Grid, Icon, Card, Button, IconButton } from '@mui/material'
...
const ChartHeader = styled(FlexBox)(({ theme }) => ({
            ...
            <Grid container spacing={3}>
                <Grid sx={{ mt: 4 }} item xs={12}>
                    <H3 sx={{ fontSize: '1.25rem' }}>
                        Most{' '}
                        <Span
                            sx={{ fontSize: '.9375rem', color: colorPrimary }}
                        >
                            Recent Media
                        </Span>
                    </H3>
                ...
                <Card>
                    ...
                    <AdvanceAreaChart
                        chartData={[
                            {
                                name: 'Series 1',
                                data: [20, 90, 20, 90, 20, 90, 20],
                            },
                            {
                                name: 'Series 2',
                                data: [90, 20, 90, 20, 90, 20, 90],
                            },
                        ]}
                        colors={[
                    ...
                    <Card sx={{ pb: 2 }}>
                        ...
                        <AdvanceLineChart2
                            chartData={[
                                {
                                    name: 'Like',
                                    data: [40, 80, 20, 90, 30, 80, 40, 90, 130],
                                },
                                {
                                    name: 'Average like per day',
                                    data: [40, 60, 10, 70, 50, 90, 70, 60, 80],
                                },
                            ]}
                        ...
                        chartData={[
                            {
                                name: 'Sat',
                                data: [
                                    40, 80, 20, 90, 30, 80, 40, 90, 130, 120,
                                    135, 145, 30, 80, 40, 90, 130, 120, 135,
                                    145,
                                ],
                            },
                            {
...
const mostRecentMedia = [
    {
        ...
        imgUrl: 'https://arctic.ui-lib.com/preview/layout1/assets/images/gallery/sq-10.jpg',
    },
    {
        like: '2.3K',
        comment: 900,
        uploadDate: '23 days ago',
        imgUrl: 'https://arctic.ui-lib.com/preview/layout1/assets/images/gallery/sq-8.jpg',
    },
    {
        like: '2.3K',
        comment: 900,
        uploadDate: '23 days ago',
        imgUrl: 'https://arctic.ui-lib.com/preview/layout1/assets/images/gallery/sq-6.jpg',
    },
    {
        like: '2.3K',
        comment: 900,
        uploadDate: '23 days ago',
        imgUrl: 'https://arctic.ui-lib.com/preview/layout1/assets/images/gallery/sq-4.jpg',
    },
]
